    ...
    <div class="container">
        ...
        <div class="display-container">
            ...
            <div id="content" class="content">
                ...
                <form id="signupUserForm" action="<?php echo "editRoom.php?id=$roomId" ; ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input id="monthlyCharge" name="monthlyCharge" type="text" placeholder=" Enter monthly charge "
                            value="<?php echo $room->getMonthlyCharge() ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="roomAllocated">Room allocated?: </label>
                        <input id="roomAllocated" name="roomAllocated" type="text" placeholder=" Enter monthly charge "
                            value="<?php echo $room->getRoomAllocated() ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="paymentStatus">Payment Status: </label>
                        <input id="paymentStatus" name="paymentStatus" type="text" placeholder=" Enter monthly charge "
                            value="<?php echo $room->getPaymentStatus() ?>" required>
                    </div>


                    <button id="updateRoomButton" style="margin: 10px;" type="submit" name="updateRoomButton">Update
                        Room Details</button>
